      ...
      <div className="relative w-full max-w-lg backdrop-blur-xl bg-white/60 dark:bg-gray-900/60 rounded-2xl border border-gray-200/80 dark:border-gray-800/80 px-8 py-10 shadow-2xl transition-all duration-300 my-8">
        <div className="relative flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            আপনার বিস্তারিত তথ্য দিয়ে নিবন্ধন করুন
          </p>
          ...
          >
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className="space-y-1.5">
                  <FieldLabel className="text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wide">আপনার নাম</FieldLabel>
                  <Input
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className="space-y-1.5">
                  <FieldLabel className="text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wide">ছবির ইউআরএল (Photo URL)</FieldLabel>
                  <Input
                    aria-invalid={fieldState.invalid}
                    className="w-full h-11 rounded-xl border-gray-200 dark:border-gray-800 focus-visible:ring-[#FA9500] bg-white/50 dark:bg-gray-950/50 transition-all"
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className="space-y-1.5">
                  <FieldLabel className="text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wide">পাসওয়ার্ড</FieldLabel>
                  <Input
                    aria-invalid={fieldState.invalid}
                    className="w-full h-11 rounded-xl border-gray-200 dark:border-gray-800 focus-visible:ring-[#FA9500] bg-white/50 dark:bg-gray-950/50 transition-all"
                    placeholder="••••••••"
            ...
            <Button 
              className="w-full h-11 mt-2 bg-[#FA9500] hover:bg-[#e08600] text-white font-medium rounded-xl shadow-lg shadow-[#FA9500]/20 transition-all active:scale-[0.98]" 
              type="submit"
            >
              নিবন্ধন করুন
            </Button>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link className="ml-1.5 font-medium text-[#FA9500] hover:underline" href="/login">
              লগ ইন করুন
            </Link>
          </p>
        </div>
